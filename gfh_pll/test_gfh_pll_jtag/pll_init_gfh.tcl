...
set GFH_PLL_CTRL1_ADDR 0x26000100
set GFH_PLL_CTRL2_ADDR 0x26000104
set GFH_PLL_CTRL3_ADDR 0x26000108
...
set current_ctrl1 [mrd $GFH_PLL_CTRL1_ADDR]
set new_ctrl1 [expr {$current_ctrl1 & (!$PLL_ENABLE_BIT)}]
mwr $GFH_PLL_CTRL1_ADDR $new_ctrl1
...
mwr $GFH_PLL_CTRL2_ADDR $reg_ctrl2_val
...
while {$timeout > 0} {
	set pll_status [mrd $GFH_PLL_CTRL1_ADDR]
